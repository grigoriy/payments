...
class TestConfig {
  ...
  lazy val accountService: SynchronizedAccountService = new SynchronizedAccountService(accountDao, accountIdGenerator)
  lazy val transferService: SynchronizedTransferService =
